...
namespace EWiki.Api.Migrations
{
    ...
    [Migration("20160911172356_UpdateForgeinKey")]
    partial class UpdateForgeinKey
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("EWiki.Api.Models.PageRestriction", b =>
                {
                    ...
                    b.Property<int?>("PageResctrictedId");
            ...
            modelBuilder.Entity("EWiki.Api.Models.CharacterSectionGroup", b =>
                {
                    b.HasOne("EWiki.Api.Models.Character")
                        .WithMany("CharacterSectionGroups")
                        .HasForeignKey("CharacterId");
            ...
            modelBuilder.Entity("EWiki.Api.Models.PageLang", b =>
                {
                    ...
                    b.HasOne("EWiki.Api.Models.Page", "LangPage")
                        .WithMany("PageLangs")
            ...
            modelBuilder.Entity("EWiki.Api.Models.PageRestriction", b =>
                {
                    ...
                    b.HasOne("EWiki.Api.Models.Page", "PageResctricted")
                        .WithMany("PageRestrictions")
                        .HasForeignKey("PageResctrictedId");
            ...
            modelBuilder.Entity("EWiki.Api.Models.Revision", b =>
                {
                    ...
                    b.HasOne("EWiki.Api.Models.Page", "PageContain")
                        .WithMany("Revisions")
                        .HasForeignKey("PageId")
                        .OnDelete(DeleteBehavior.Cascade);
