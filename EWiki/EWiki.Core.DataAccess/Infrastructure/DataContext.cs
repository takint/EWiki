...
namespace EWiki.DataAccess.Infrastructure
{
    public class DataContext : DbContext, IDataContext
    {
        ...
        {
            Entry(entity).State = StateHelper.ConvertState(entity.ObjState);
        }
        ...
        private void SyncObjectsStatePreCommit()
        {
            ...
            {
                dbEntityEntry.State = StateHelper.ConvertState(((IObjectState)dbEntityEntry.Entity).ObjState);
            }
        }
        ...
        public void SyncObjectsStatePostCommit()
        {
            foreach (var dbEntityEntry in ChangeTracker.Entries())
            {
                ((IObjectState)dbEntityEntry.Entity).ObjState = StateHelper.ConvertState(dbEntityEntry.State);
            }
        }
