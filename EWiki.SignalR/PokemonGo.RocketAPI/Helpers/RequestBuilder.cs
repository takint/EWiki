...
namespace PokemonGo.RocketAPI.Helpers
{
    public class RequestBuilder
    {
        ...
        { 
            ...
            string DevicePackageName = arrLine.Length > 0 && arrLine[0] != null ? arrLine[0].ToString() : "lg-optimus-g"; 
            // Read DeviceID of File
            if (arrLine.Length > 0 && !string.IsNullOrEmpty(arrLine[1].ToString().Trim()))
            {
